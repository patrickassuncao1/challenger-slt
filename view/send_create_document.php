...
<section class="container block mx-auto mt-8">
    <div class="px-2 sm:px-4">
        ...
        <div class="max-w-2xl mt-8">
            ...
            ?>
            <form action="/document-processing/create-sector-send" method="post" class="w-full">
                <div>
                    <label for="sector_id" class="block mb-4 text-sm font-medium text-gray-900">Para qual setor deseja enviar</label>
                ...
                <button type="submit" class="text-white mt-8 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Enviar</button>
            </form>
        </div>
    </div>
</section>